...
static uint32_t i915_get_genx10(int device_id)
{
	...
	const uint16_t gen12_ids[] = { 0x9A40, 0x9A49, 0x9A59, 0x9A60, 0x9A68, 0x9A70, 0x9A78,
				       0xFF20, 0x4905, 0x4906, 0x4907, 0x4f80, 0x0201, 0xFF25 };
	...
	const uint16_t dg2_ids[] = {
		...
		0x56AA, 0x56AB, 0x56AC, 0x56AD, 0x56AE, 0x56AF,

		// DG2 Notebook Reserved:  5690 to 569F
		0x5690, 0x5691, 0x5692, 0x5693, 0x5694, 0x5695, 0x5696, 0x5697, 0x5698, 0x5699,
		0x569A, 0x569B, 0x569C, 0x569D, 0x569E, 0x569F,

		// Workstation Reserved:  56B0 to 56BF
		0x56B0, 0x56B1, 0x56B2, 0x56B3, 0x56B4, 0x56B5, 0x56B6, 0x56B7, 0x56B8, 0x56B9,
		0x56BA, 0x56BB, 0x56BC, 0x56BD, 0x56BE, 0x56BF,

		// Server Reserved:  56C0 to 56CF
		0x56C0, 0x56C1, 0x56C2, 0x56C3, 0x56C4, 0x56C5, 0x56C6, 0x56C7, 0x56C8, 0x56C9,
		0x56CA, 0x56CB, 0x56CC, 0x56CD, 0x56CE, 0x56CF
        };
